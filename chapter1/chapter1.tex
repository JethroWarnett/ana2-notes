      ...
      \begin{enumerate}[(i)]
        ...
        \item Berechne
          \begin{align*}
            ...
            &\leq \max \left\{|v_{1}|+|w_{1}|, \dots, |v_{n}|+|w_{n}|\right\}\\
...
\begin{remark}
  Falls gilt
   \[
      \langle v, w \rangle = \sqrt{\langle v, v \rangle}
      \cdot \sqrt{\langle w, w \rangle},
    \]
    dann hat man $D=0$. Es existiert somit ein $t\in\mathbb{R}$
    mit $0=h(t)=\langle v+tw,v+tw\rangle=\Vert v+tw\Vert$. Das
    heisst $v+tw=0$, also sind $v$ und $w$ linear abhängig.
\end{remark}
...
\begin{remark}
  ...
  In der Serie 01, Übung 1 wird gezeigt, dass jede von einem Skalarprodukt
